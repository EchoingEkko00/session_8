...
class Elements {
  ...
  LinearGradient getColor() {
    if (cpkHex.toString() != "null") {
      return LinearGradient(colors: [Color(int.parse("0x" + cpkHex.toString())), Colors.grey]);
    } else {
      return LinearGradient(colors: [Colors.blue, Colors.red],begin: FractionalOffset.topLeft, end: FractionalOffset.bottomRight);
    }
  }
