...
public class JDBCclass {
    ...
    private static final String DB_URL = "jdbc:h2:~/registrationJDBC";
    ...
    private static String sqlPs = "SELECT id, first, last, age FROM Registration" +
            " WHERE id == ?";;
    private static String insertRegistration = "INSERT INTO REGISTRATION (id, first, last, age) VALUES (?,?,?,?)";
