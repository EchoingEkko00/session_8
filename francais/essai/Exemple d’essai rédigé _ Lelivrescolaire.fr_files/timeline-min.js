...
!(function (t) {
  ...
  (TL.Util = {
    ...
    extend: function (t) {
      for (var e = Array.prototype.slice.call(arguments, 1), i = 0, n = e.length, a; i < n; i++)
        (a = e[i] || {}), TL.Util.mergeData(t, a)
      return t
    },
    isEven: function (t) {
    ...
    convertUnixTime: function (t) {
      var e,
        ...
        o,
        r = [],
        l = { ymd: '', time: '', time_array: [], date_array: [], full_array: [] }
      ;(l.ymd = t.split(' ')[0]),
        (l.time = t.split(' ')[1]),
        (l.date_array = l.ymd.split('-')),
        (l.time_array = l.time.split(':')),
        (l.full_array = l.date_array.concat(l.time_array))
      for (var h = 0; h < l.full_array.length; h++) r.push(parseInt(l.full_array[h]))
      return (
        (i = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']),
        (n = (e = new Date(r[0], r[1], r[2], r[3], r[4], r[5])).getFullYear()),
        (o = (a = i[e.getMonth()]) + ', ' + (s = e.getDate()) + ' ' + n)
      )
    },
    setData: function (t, e) {
      ;(t.data = TL.Util.extend({}, t.data, e)),
        '' === t.data.unique_id && (t.data.unique_id = TL.Util.unique_ID(6))
    },
    stamp: (function () {
      var e = 0,
        i = '_tl_id'
      return function (t) {
        return (t[i] = t[i] || ++e), t[i]
      }
    })(),
    isArray: (function () {
    ...
    unique_ID: function (t, e) {
      var i = function (t) {
        ...
        n = function () {
          var t
          return 'abcdefghijklmnopqurstuvwxyz'.substr(i(32), 1)
        },
        a = function (t) {
    ...
    linkify: function (t, e, i) {
      var s = function (t, e, i) {
          ...
          var n = 30
          return (
            e && 30 < e.length && (e = e.substring(0, 30) + '…'),
      ...
      return t
        ...
        .replace(a, function (t, e, i, n, a) {
          return s('http://' + i, i, e)
        })
        .replace(o, function (t, e, i, n) {
          return s('mailto:' + e, e)
        })
    },
    ...
    requestAnimFrame: (function () {
      ...
      return function (t, e, i, n) {
        ;(t = e ? TL.Util.bind(t, e) : t), i && s === a ? t() : s(t, n)
      }
    })(),
    bind: function (t, e) {
      return function () {
    ...
    template: function (t, n) {
      return t.replace(/\{ *([\w_]+) *\}/g, function (t, e) {
        var i = n[e]
        if (!n.hasOwnProperty(e)) throw new TL.Error('template_value_err', t)
        return i
      })
    },
    hexToRgb: function (t) {
    ...
    ratio: {
      square: function (t) {
        var e = { w: 0, h: 0 }
        return t.w > t.h && 0 < t.h ? ((e.h = t.h), (e.w = t.h)) : ((e.w = t.w), (e.h = t.w)), e
      },
      r16_9: function (t) {
        return null !== t.w && '' !== t.w
          ? Math.round((t.w / 16) * 9)
    ...
    slugify: function (t) {
      t = (t = TL.Util.trim(t)).toLowerCase()
      for (
        var e = 'ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;',
          i = 'aaaaaeeeeeiiiiooooouuuunc------',
          n = 0,
          a = e.length;
        n < a;
        n++
      ...
      if ('string' == typeof t) {
        if (((parts = t.match(/^\s*(\d+h)?(\d+m)?(\d+s)?\s*/i)), parts)) {
          var e = parseInt(parts[1]) || 0,
            ...
            n
          return (parseInt(parts[3]) || 0) + 60 * i + 60 * e * 60
        }
    ...
    base58: (function (t) {
      var a = '123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ',
        s = a.length
      return {
        encode: function (t) {
          ...
          for (var e = ''; t; ) {
            var i = t % s
            ;(t = Math.floor(t / s)), (e = a[i].toString() + e)
          }
          return e
        },
        decode: function (t) {
          ...
          for (var e = 0; t; ) {
            var i = a.indexOf(t[0])
            if (i < 0) throw '"decode" can\'t find "' + t[0] + '" in the alphabet: "' + a + '"'
            var n = t.length - 1
            ;(e += i * Math.pow(s, n)), (t = t.substring(1))
          }
          return e
        }
      }
  ...
  (function (uc) {
    var vc = (function () {
        ...
        function c(t) {
          return 0 < t.length ? k.fn.concat.apply([], t) : t
        }
        function u(t) {
          return t
            .replace(/::/g, '/')
        ...
        function L(t, e) {
          for (var i in (e(t), t.childNodes)) L(t.childNodes[i], e)
        }
        var w,
          b,
          k,
        ...
        return (
          (Z.matches = function (t, e) {
            ...
            var n,
              ...
              s = !a
            return (
              s && (a = V).appendChild(t), (n = ~Z.qsa(a, e).indexOf(t)), s && V.removeChild(t), n
            )
          }),
          (G = function (t) {
          ...
          (Z.fragment = function (t, e, i) {
            var n, a, s
            return (
              U.test(t) && (n = k(S.createElement(RegExp.$1))),
              n ||
                (t.replace && (t = t.replace(A, '<$1></$2>')),
                e === w && (e = I.test(t) && RegExp.$1),
                e in q || (e = '*'),
                ((s = q[e]).innerHTML = '' + t),
                (n = k.each(D.call(s.childNodes), function () {
                  s.removeChild(this)
                }))),
              h(i) &&
                ((a = k(n)),
                k.each(i, function (t, e) {
                  ;-1 < P.indexOf(t) ? a[t](e) : a.attr(t, e)
                })),
              n
            )
          }),
          (Z.Z = function (t, e) {
            return ((t = t || []).__proto__ = k.fn), (t.selector = e || ''), t
          }),
          (Z.isZ = function (t) {
          ...
          (Z.init = function (t, e) {
            ...
            if (!t) return Z.Z()
            if ('string' == typeof t)
              if ('<' == (t = t.trim())[0] && I.test(t))
                (i = Z.fragment(t, RegExp.$1, e)), (t = null)
              else {
                if (e !== w) return k(e).find(t)
                i = Z.qsa(S, t)
              }
            else {
              if (o(t)) return k(S).ready(t)
              if (Z.isZ(t)) return t
              if (K(t)) i = a(t)
          ...
          ((k = function (t, e) {
            ...
            return (
              'boolean' == typeof e && ((i = e), (e = t.shift())),
          ...
          (k.map = function (t, e) {
            var i,
              ...
              a,
              s
            if (d(t)) for (a = 0; a < t.length; a++) null != (i = e(t[a], a)) && n.push(i)
            else for (s in t) null != (i = e(t[s], s)) && n.push(i)
            return c(n)
          }),
          (k.each = function (t, e) {
            var i, n
          ...
          (k.fn = {
            ...
            get: function (t) {
              return t === w ? D.call(this) : this[0 <= t ? t : t + this.length]
            },
            toArray: function () {
              return this.get()
            },
            ...
            each: function (i) {
              return (
                M.every.call(this, function (t, e) {
                  return !1 !== i.call(t, e, t)
                }),
                this
              )
            },
            ...
            not: function (e) {
              ...
              if (o(e) && e.call !== w)
                ...
                var n = 'string' == typeof e ? this.filter(e) : d(e) && o(e.item) ? D.call(e) : k(e)
            ...
            has: function (t) {
              return this.filter(function () {
                return n(t) ? k.contains(this, t) : k(this).find(t).size()
              })
            },
            eq: function (t) {
            ...
            find: function (t) {
              ...
              return (e =
                'object' == typeof t
                  ? k(t).filter(function () {
                      var e = this
                      return M.some.call(i, function (t) {
            ...
            closest: function (t, e) {
              var i = this[0],
                n = !1
              for (
                'object' == typeof t && (n = k(t));
                i && !(n ? 0 <= n.indexOf(i) : Z.matches(i, t));

              )
                i = i !== e && !l(i) && i.parentNode
              return k(i)
            },
            parents: function (t) {
              for (var e = [], i = this; 0 < i.length; )
            ...
            parent: function (t) {
              return f(J(this.pluck('parentNode')), t)
            },
            children: function (t) {
              return f(
                this.map(function () {
            ...
            siblings: function (t) {
              return f(
                this.map(function (t, e) {
                  return E.call(_(e.parentNode), function (t) {
                    return t !== e
                  })
                }),
                t
            ...
            wrap: function (e) {
              ...
              if (this[0] && !i)
                var n = k(e).get(0),
                  a = n.parentNode || 1 < this.length
              return this.each(function (t) {
                k(this).wrapAll(i ? e.call(this, t) : a ? n.cloneNode(!0) : n)
              })
            },
            wrapAll: function (t) {
              if (this[0]) {
                var e
                for (k(this[0]).before((t = k(t))); (e = t.children()).length; ) t = e.first()
                k(t).append(this)
              }
              return this
            },
            ...
            html: function (i) {
              return 0 === arguments.length
                ...
                : this.each(function (t) {
                    ...
                    k(this).empty().append(g(this, i, t, e))
                  })
            },
            text: function (t) {
              return 0 === arguments.length
            ...
            attr: function (e, i) {
              ...
              return 'string' == typeof e && i === w
                ...
                : this.each(function (t) {
                    if (1 === this.nodeType)
                      if (n(e)) for (b in e) v(this, b, e[b])
                      else v(this, e, g(this, i, t, this.getAttribute(e)))
                  })
            },
            ...
            prop: function (e, i) {
              return (
                ...
                i === w
                  ? this[0] && this[0][e]
                  : this.each(function (t) {
                      this[e] = g(this, i, t, this[e])
                    })
              )
            },
            data: function (t, e) {
              var i = this.attr('data-' + t.replace(O, '-$1').toLowerCase(), e)
              return null !== i ? T(i) : w
            },
            val: function (e) {
              return 0 === arguments.length
            ...
            offset: function (s) {
              if (s)
                return this.each(function (t) {
                  var e = k(this),
                    i = g(this, s, t, e.offset()),
                    n = e.offsetParent().offset(),
                    a = { top: i.top - n.top, left: i.left - n.left }
                  'static' == e.css('position') && (a.position = 'relative'), e.css(a)
                })
            ...
            css: function (t, e) {
              if (arguments.length < 2) {
                ...
                if (!i) return
                if ('string' == typeof t) return i.style[G(t)] || n.getPropertyValue(t)
                if (K(t)) {
                  var a = {}
                  return (
                    k.each(K(t) ? t : [t], function (t, e) {
                      a[e] = i.style[G(e)] || n.getPropertyValue(e)
                    }),
                    a
                  )
                }
              ...
              return n
                ? this.each(function (t) {
                    ...
                    g(this, n, t, e)
                      .split(/\s+/g)
                      .forEach(function (t) {
                        k(this).hasClass(t) || x.push(t)
                      }, this),
                      x.length && y(this, e + (e ? ' ' : '') + x.join(' '))
                  })
                : this
            },
            removeClass: function (e) {
              return this.each(function (t) {
                if (e === w) return y(this, '')
                ;(x = y(this)),
                  g(this, e, t, x)
                    .split(/\s+/g)
                    .forEach(function (t) {
              ...
              return n
                ? this.each(function (t) {
                    ...
                    g(this, n, t, y(this))
                      .split(/\s+/g)
                      .forEach(function (t) {
                        ;(a === w ? !e.hasClass(t) : a) ? e.addClass(t) : e.removeClass(t)
                      })
                  })
                : this
            },
            ...
            position: function () {
              if (this.length) {
                var t = this[0],
                  e = this.offsetParent(),
                  i = this.offset(),
                  n = j.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset()
                return (
                  (i.top -= parseFloat(k(t).css('margin-top')) || 0),
                  (i.left -= parseFloat(k(t).css('margin-left')) || 0),
                  (n.top += parseFloat(k(e[0]).css('border-top-width')) || 0),
                  (n.left += parseFloat(k(e[0]).css('border-left-width')) || 0),
            ...
            offsetParent: function () {
              return this.map(function () {
                for (
                  var t = this.offsetParent || S.body;
                  t && !j.test(t.nodeName) && 'static' == k(t).css('position');
            ...
            k.fn[n] = function (e) {
              ...
              return e === w
                ? s(i)
                  ? i['inner' + a]
                  : l(i)
                  ? i.documentElement['scroll' + a]
                  : (t = this.offset()) && t[n]
                : this.each(function (t) {
                    ;(i = k(this)).css(n, g(this, e, t, i[n]()))
                  })
            }
          }),
          B.forEach(function (e, s) {
            var o = s % 2
            ;(k.fn[e] = function () {
              var e,
                i = k.map(arguments, function (t) {
                  return 'object' == (e = r(t)) || 'array' == e || null == t ? t : Z.fragment(t)
                }),
                n,
                a = 1 < this.length
              return i.length < 1
                ...
                : this.each(function (t, e) {
                    ;(n = o ? e : e.parentNode),
                      ...
                      i.forEach(function (t) {
                        ...
                        else if (!n) return k(t).remove()
                        L(n.insertBefore(t, e), function (t) {
                          null == t.nodeName ||
              ...
              (k.fn[o ? e + 'To' : 'insert' + (s ? 'Before' : 'After')] = function (t) {
                return k(t)[e](this), this
              })
          }),
          (Z.Z.prototype = k.fn),
          (Z.uniq = J),
          (Z.deserializeValue = T),
          (k.zepto = Z),
          k
        )
      })(),
      Um
    ;(window.Zepto = vc),
      void 0 === window.$ && (window.$ = vc),
      (function (d) {
        function c(t) {
          return t._zid || (t._zid = e++)
        }
        function o(t, e, i, n) {
          if ((e = u(e)).ns) var a = s(e.ns)
          return (w[c(t)] || []).filter(function (t) {
            return (
              t &&
              (!e.e || t.e == e.e) &&
              (!e.ns || a.test(t.ns)) &&
        ...
        function m(t, e) {
          return (t.del && !i && t.e in n) || !!e
        }
        function _(t) {
          return b[t] || (i && n[t]) || t
        }
        function h(a, t, e, s, o, r, l) {
          var i = c(a),
            h = w[i] || (w[i] = [])
            ...
            ;(i.fn = e),
              ...
              i.e in b &&
                (e = function (t) {
                  ...
                  if (!e || (e !== this && !d.contains(this, e))) return i.fn.apply(this, arguments)
                })
            var n = (i.del = r) || e
            ;(i.proxy = function (t) {
              if (!(t = f(t)).isImmediatePropagationStopped()) {
                t.data = s
                var e = n.apply(a, t._args == v ? [t] : [t].concat(t._args))
                return !1 === e && (t.preventDefault(), t.stopPropagation()), e
              }
            }),
              (i.i = h.length),
              h.push(i),
              'addEventListener' in a && a.addEventListener(_(i.e), i.proxy, m(i, l))
          })
        }
        function p(e, t, i, n, a) {
          var s = c(e)
          ;(t || '').split(/\s/).forEach(function (t) {
            o(e, t, i, n).forEach(function (t) {
              delete w[s][t.i],
                'removeEventListener' in e && e.removeEventListener(_(t.e), t.proxy, m(t, a))
            })
          })
        }
        function f(n, a) {
          return (
            (!a && n.isDefaultPrevented) ||
              ...
              d.each(x, function (t, e) {
                var i = a[t]
                ;(n[t] = function () {
                  return (this[e] = l), i && i.apply(a, arguments)
                }),
                  (n[e] = k)
              }),
              (a.defaultPrevented !== v
                ? a.defaultPrevented
                : 'returnValue' in a
                ? !1 === a.returnValue
                : a.getPreventDefault && a.getPreventDefault()) && (n.isDefaultPrevented = l)),
            n
          )
        }
        function g(t) {
          var e,
            i = { originalEvent: t }
          for (e in t) a.test(e) || t[e] === v || (i[e] = t[e])
          return f(i, t)
        }
        var t = d.zepto.qsa,
          e = 1,
        ...
        ;(r.click = r.mousedown = r.mouseup = r.mousemove = 'MouseEvents'),
          ...
          (d.proxy = function (t, e) {
            ...
            if (L(e)) return d.proxy(t[e], t)
            throw new TypeError('expected function')
          }),
          (d.fn.bind = function (t, e, i) {
            return this.on(t, e, i)
          }),
          (d.fn.unbind = function (t, e) {
            return this.off(t, e)
          }),
          (d.fn.one = function (t, e, i, n) {
        ...
        ;(d.fn.delegate = function (t, e, i) {
          return this.on(e, t, i)
        }),
          (d.fn.undelegate = function (t, e, i) {
          ...
          (d.fn.on = function (e, a, i, s, o) {
            ...
            return e && !L(e)
              ? (d.each(e, function (t, e) {
                ...
                n)
              : (L(a) || T(s) || !1 === s || ((s = i), (i = a), (a = v)),
                (T(i) || !1 === i) && ((s = i), (i = v)),
                !1 === s && (s = k),
                n.each(function (t, n) {
                  o &&
                    (r = function (t) {
                      return p(n, t.type, s), s.apply(this, arguments)
                    }),
                    a &&
                      (l = function (t) {
                        var e,
                          i = d(t.target).closest(a, n).get(0)
                        if (i && i !== n)
                          return (
                            (e = d.extend(g(t), { currentTarget: i, liveFired: n })),
                            (r || s).apply(i, [e].concat(y.call(arguments, 1)))
                          )
                      }),
                    h(n, e, s, i, a, l || r)
                }))
          }),
          (d.fn.off = function (t, i, e) {
            var n = this
            return t && !L(t)
          ...
          (d.fn.trigger = function (t, e) {
            return (
              ((t = L(t) || d.isPlainObject(t) ? d.Event(t) : f(t))._args = e),
              this.each(function () {
                'dispatchEvent' in this ? this.dispatchEvent(t) : d(this).triggerHandler(t, e)
              })
            )
          }),
          (d.fn.triggerHandler = function (i, n) {
            var a, s
            return (
              this.each(function (t, e) {
                ;((a = g(L(i) ? d.Event(i) : i))._args = n),
                  (a.target = e),
                  d.each(o(e, i.type || i), function (t, e) {
          ...
          (d.Event = function (t, e) {
            ...
            return i.initEvent(t, n, !0), f(i)
          })
      })(vc),
      (function (xk) {
        function Ik(t, e, i) {
          var n = xk.Event(e)
          return xk(t).trigger(n, i), !n.isDefaultPrevented()
        }
        function Jk(t, e, i, n) {
          if (t.global) return Ik(e || zk, i, n)
        }
        function Kk(t) {
          t.global && 0 == xk.active++ && Jk(t, null, 'ajaxStart')
        }
        function Lk(t) {
          t.global && !--xk.active && Jk(t, null, 'ajaxStop')
        }
        function Mk(t, e) {
          var i = e.context
          if (!1 === e.beforeSend.call(i, t, e) || !1 === Jk(e, i, 'ajaxBeforeSend', [t, e]))
            return !1
          Jk(e, i, 'ajaxSend', [t, e])
        }
        function Nk(t, e, i, n) {
          var a = i.context,
            s = 'success'
          i.success.call(a, t, s, e),
            n && n.resolveWith(a, [t, s, e]),
            Jk(i, a, 'ajaxSuccess', [e, i, t]),
            Pk(s, e, i)
        }
        function Ok(t, e, i, n, a) {
          var s = n.context
          n.error.call(s, i, e, t),
            a && a.rejectWith(s, [i, e, t]),
            Jk(n, s, 'ajaxError', [i, n, t || e]),
            Pk(e, i, n)
        }
        function Pk(t, e, i) {
          var n = i.context
          i.complete.call(n, e, t), Jk(i, n, 'ajaxComplete', [e, i]), Lk(i)
        }
        function Qk() {}
        function Rk(t) {
          return (
        ...
        function Tk(t) {
          t.processData &&
            t.data &&
            'string' != xk.type(t.data) &&
            (t.data = xk.param(t.data, t.traditional)),
            !t.data ||
              (t.type && 'GET' != t.type.toUpperCase()) ||
              ((t.url = Sk(t.url, t.data)), (t.data = void 0))
        }
        function Uk(t, e, i, n) {
          var a = !xk.isFunction(e)
          return {
            url: t,
            data: a ? e : void 0,
            success: a ? (xk.isFunction(i) ? i : void 0) : e,
            dataType: (a && n) || i
          }
        }
        function Wk(i, t, n, a) {
          var s,
            o = xk.isArray(t),
            r = xk.isPlainObject(t)
          xk.each(t, function (t, e) {
            ;(s = xk.type(e)),
              a && (t = n ? a : a + '[' + (r || 'object' == s || 'array' == s ? t : '') + ']'),
              !a && o
        ...
        var yk = 0,
          ...
          Ak,
          Bk,
          Ck = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
          Dk = /^(?:text|application)\/javascript/i,
          Ek = /^(?:text|application)\/xml/i,
          Fk = 'application/json',
          Gk = 'text/html',
          Hk = /^\s*$/
        ;(xk.active = 0),
          (xk.ajaxJSONP = function (i, n) {
            if (!('type' in i)) return xk.ajax(i)
            var t = i.jsonpCallback,
              a = (xk.isFunction(t) ? t() : t) || 'jsonp' + ++yk,
              s = zk.createElement('script'),
              o = window[a],
              r,
              e = function (t) {
                xk(s).triggerHandler('error', t || 'abort')
              },
              l = { abort: e },
              h
            return (
              n && n.promise(l),
              xk(s).on('load error', function (t, e) {
                clearTimeout(h),
                  xk(s).off().remove(),
                  'error' != t.type && r ? Nk(r[0], l, i, n) : Ok(null, e || 'error', l, i, n),
                  (window[a] = o),
                  r && xk.isFunction(o) && o(r[0]),
                  (o = r = void 0)
              }),
              !1 === Mk(l, i)
                ? e('abort')
          ...
          (xk.ajax = function (Pl) {
            var Ql = xk.extend({}, Pl || {}),
              Rl = xk.Deferred && xk.Deferred()
            for (Ak in xk.ajaxSettings) void 0 === Ql[Ak] && (Ql[Ak] = xk.ajaxSettings[Ak])
            Kk(Ql),
              Ql.crossDomain ||
                (Ql.crossDomain =
                  /^([\w-]+:)?\/\/([^\/]+)/.test(Ql.url) && RegExp.$2 != window.location.host),
              Ql.url || (Ql.url = window.location.toString()),
              Tk(Ql),
              !1 === Ql.cache && (Ql.url = Sk(Ql.url, '_=' + Date.now()))
            var Sl = Ql.dataType,
              Tl = /\?.+=\?/.test(Ql.url)
            if ('jsonp' == Sl || Tl)
              return (
                Tl ||
                  (Ql.url = Sk(
                    Ql.url,
                    Ql.jsonp ? Ql.jsonp + '=?' : !1 === Ql.jsonp ? '' : 'callback=?'
                  )),
                xk.ajaxJSONP(Ql, Rl)
              )
            var Ul = Ql.accepts[Sl],
              Vl = {},
              Wl = function (t, e) {
                Vl[t.toLowerCase()] = [t, e]
              },
              Xl = /^([\w-]+:)\/\//.test(Ql.url) ? RegExp.$1 : window.location.protocol,
              Yl = Ql.xhr(),
              Zl = Yl.setRequestHeader,
              $l
            if (
              (Rl && Rl.promise(Yl),
              Ql.crossDomain || Wl('X-Requested-With', 'XMLHttpRequest'),
              Wl('Accept', Ul || '*/*'),
              (Ul = Ql.mimeType || Ul) &&
                (-1 < Ul.indexOf(',') && (Ul = Ul.split(',', 2)[0]),
                Yl.overrideMimeType && Yl.overrideMimeType(Ul)),
              (Ql.contentType ||
                (!1 !== Ql.contentType && Ql.data && 'GET' != Ql.type.toUpperCase())) &&
                Wl('Content-Type', Ql.contentType || 'application/x-www-form-urlencoded'),
              Ql.headers)
            )
              for (Bk in Ql.headers) Wl(Bk, Ql.headers[Bk])
            if (
              ((Yl.setRequestHeader = Wl),
              !(Yl.onreadystatechange = function () {
                if (4 == Yl.readyState) {
                  ;(Yl.onreadystatechange = Qk), clearTimeout($l)
                  var cm,
                    dm = !1
                  if (
                    (200 <= Yl.status && Yl.status < 300) ||
                    304 == Yl.status ||
                    (0 == Yl.status && 'file:' == Xl)
                  ) {
                    ;(Sl = Sl || Rk(Ql.mimeType || Yl.getResponseHeader('content-type'))),
                      (cm = Yl.responseText)
                    try {
                      'script' == Sl
                        ? eval(cm)
                        : 'xml' == Sl
                        ? (cm = Yl.responseXML)
                        : 'json' == Sl && (cm = Hk.test(cm) ? null : xk.parseJSON(cm))
                    } catch (t) {
                      dm = t
                    }
                    dm ? Ok(dm, 'parsererror', Yl, Ql, Rl) : Nk(cm, Yl, Ql, Rl)
                  } else Ok(Yl.statusText || null, Yl.status ? 'error' : 'abort', Yl, Ql, Rl)
                }
              }) === Mk(Yl, Ql))
            )
              return Yl.abort(), Ok(null, 'abort', Yl, Ql, Rl), Yl
            if (Ql.xhrFields) for (Bk in Ql.xhrFields) Yl[Bk] = Ql.xhrFields[Bk]
            var _l = !('async' in Ql) || Ql.async
            for (Bk in (Yl.open(Ql.type, Ql.url, _l, Ql.username, Ql.password), Vl))
              Zl.apply(Yl, Vl[Bk])
            return (
              0 < Ql.timeout &&
                ($l = setTimeout(function () {
                  ;(Yl.onreadystatechange = Qk), Yl.abort(), Ok(null, 'timeout', Yl, Ql, Rl)
                }, Ql.timeout)),
              Yl.send(Ql.data ? Ql.data : null),
              Yl
            )
          }),
          (xk.get = function (t, e, i, n) {
            return xk.ajax(Uk.apply(null, arguments))
          }),
          (xk.post = function (t, e, i, n) {
            var a = Uk.apply(null, arguments)
            return (a.type = 'POST'), xk.ajax(a)
          }),
          (xk.getJSON = function (t, e, i) {
            var n = Uk.apply(null, arguments)
            return (n.dataType = 'json'), xk.ajax(n)
          }),
          (xk.fn.load = function (t, e, i) {
            ...
            var n = this,
              ...
              r = o.success
            return (
              1 < a.length && ((o.url = a[0]), (s = a[1])),
              (o.success = function (t) {
                n.html(s ? xk('<div>').html(t.replace(Ck, '')).find(s) : t),
        ...
        var Vk = encodeURIComponent
        xk.param = function (t, e) {
          var i = []
          return (
            (i.add = function (t, e) {
              this.push(Vk(t) + '=' + Vk(e))
      ...
      ((Um = vc).fn.serializeArray = function () {
        var e = [],
          i
        return (
          Um([].slice.call(this.get(0).elements)).each(function () {
            var t = (i = Um(this)).attr('type')
            'fieldset' != this.nodeName.toLowerCase() &&
              ...
              e.push({ name: i.attr('name'), value: i.val() })
          }),
          e
        )
      }),
      (Um.fn.serialize = function () {
        var e = []
        return (
      ...
      (Um.fn.submit = function (t) {
        if (t) this.bind('submit', t)
        else if (this.length) {
          var e = Um.Event('submit')
  ...
  (TL.Class.extend = function (t) {
    ...
    var n = new i()
    for (var a in (((n.constructor = e).prototype = n), (e.superclass = this.prototype), this))
      this.hasOwnProperty(a) && 'prototype' !== a && 'superclass' !== a && (e[a] = this[a])
    return (
      t.statics && (TL.Util.extend(e, t.statics), delete t.statics),
  ...
  (TL.Events = {
    ...
    hasEventListeners: function (t) {
      var e = '_tl_events'
      return e in this && t in this[e] && 0 < this[e][t].length
    },
    removeEventListener: function (t, e, i) {
      if (!this.hasEventListeners(t)) return this
      for (var n = 0, a = this._tl_events, s = a[t].length; n < s; n++)
    ...
    fireEvent: function (t, e) {
      if (!this.hasEventListeners(t)) return this
      for (
        var i = TL.Util.mergeData({ type: t, target: this }, e),
  ...
  (function () {
    var t = navigator.userAgent.toLowerCase(),
      ...
      m = window.opera,
      _ = 'devicePixelRatio' in window && 1 < window.devicePixelRatio
    if (!_ && 'matchMedia' in window) {
    ...
    TL.Browser = {
      ...
      orientation: function () {
        var t = window.innerWidth,
          ...
          i = 'portrait'
        return (
          window.innerHeight < t && (i = 'landscape'), Math.abs(window.orientation), trace(i), i
        )
      }
    }
  })(),
  (TL.Load = (function (t) {
    ...
    return {
      css: function (t, e, i, n) {
        a(t) ? e() : TL.LoadIt.css(t, e, i, n)
      },
      js: function (t, e, i, n) {
        a(t) ? e() : TL.LoadIt.js(t, e, i, n)
      }
    }
  })(this.document)),
  (TL.LoadIt = (function (_) {
    function p(t, e) {
      var i = _.createElement(t),
        n
    ...
    function g() {
      ...
      ;((T = { async: !0 === _.createElement('script').async }).webkit = /AppleWebKit\//.test(t)) ||
        (T.ie = /MSIE/.test(t)) ||
        (T.opera = /Opera/.test(t)) ||
        (T.gecko = /Gecko\//.test(t)) ||
        (T.unknown = !0)
    }
    function a(t, e, i, n, a) {
      var s = function () {
        ...
        m
      if ((T || g(), e))
        if (((e = 'string' == typeof e ? [e] : e.concat()), o || T.async || T.gecko || T.opera))
          b[t].push({ urls: e, callback: i, obj: n, context: a })
        else
          for (l = 0, h = e.length; l < h; ++l)
            b[t].push({ urls: [e[l]], callback: l === h - 1 ? i : null, obj: n, context: a })
      if (!w[t] && (c = w[t] = b[t].shift())) {
        for (
          L || (L = _.head || _.getElementsByTagName('head')[0]), l = 0, h = (u = c.urls).length;
          l < h;
          ++l
        )
          (m = u[l]),
            o
              ? (d = T.gecko ? p('style') : p('link', { href: m, rel: 'stylesheet' }))
              : ((d = p('script', { src: m })).async = !1),
            (d.className = 'lazyload'),
            d.setAttribute('charset', 'utf-8'),
            T.ie && !o
              ? (d.onreadystatechange = function () {
                  ;/loaded|complete/.test(d.readyState) && ((d.onreadystatechange = null), s())
                })
              : o && (T.gecko || T.webkit)
              ? T.webkit
                ? ((c.urls[l] = d.href), y())
                : ((d.innerHTML = '@import "' + m + '";'), v(d))
              : (d.onload = d.onerror = s),
            r.push(d)
        for (l = 0, h = r.length; l < h; ++l) L.appendChild(r[l])
      }
    }
    function v(e) {
      var i
    ...
    function y() {
      ...
      if (t) {
        for (e = i.length; 0 <= --e; )
          if (i[e].href === t.urls[0]) {
            f('css')
            break
          }
        ;(s += 1), t && (s < 200 ? setTimeout(y, 50) : f('css'))
      }
    }
    var T,
      L,
  ...
  (TL.TimelineConfig = TL.Class.extend({
    ...
    validate: function () {
      ...
      for (var t = 0; t < this.eras.length; t++) {
        ...
        if (void 0 === this.eras[t].start_date || void 0 === this.eras[t].end_date)
          (e =
            this.eras[t].text && this.eras[t].text.headline
              ? this.eras[t].text.headline
              : 'era ' + (t + 1)),
    ...
    addEvent: function (t, e) {
      ...
      if (void 0 === t.start_date) throw new TL.Error('missing_start_date_err', i)
      return (
        this._processDates(t),
        this._tidyFields(t),
        this.events.push(t),
        (this.event_dict[i] = t),
        e || TL.DateUtil.sortByDate(this.events),
        i
      )
    },
    addEra: function (t, e) {
      ...
      return (
        ...
        this.eras.push(t),
        (this.event_dict[i] = t),
        e || TL.DateUtil.sortByDate(this.eras),
        i
      )
    },
    _assignID: function (t) {
      var e = t.unique_id
      return (
        TL.Util.trim(e) || (e = t.text ? TL.Util.slugify(t.text.headline) : null),
        (t.unique_id = TL.Util.ensureUniqueKey(this.event_dict, e)),
        t.unique_id
      )
    },
    _makeUniqueIdentifiers: function (t, e) {
      for (var i = [t], n = 0; n < e.length; n++)
        TL.Util.trim(e[n].unique_id) &&
          ((e[n].unique_id = TL.Util.slugify(e[n].unique_id)),
          -1 == i.indexOf(e[n].unique_id) ? i.push(e[n].unique_id) : (e[n].unique_id = ''))
      if (i.length != e.length + 1)
        for (var n = 0; n < e.length; n++)
          if (!e[n].unique_id) {
            var a = e[n].text ? TL.Util.slugify(e[n].text.headline) : null
            a || (a = TL.Util.unique_ID(6)),
              -1 != i.indexOf(a) && (a = a + '-' + n),
              i.push(a),
              (e[n].unique_id = a)
          }
    ...
    _ensureValidScale: function (t) {
      if (!this.scale) {
        ...
        for (var e = 0; e < t.length; e++) {
          ...
          if (t[e].start_date && void 0 !== t[e].start_date.year) {
            var i,
              n = new TL.BigDate(t[e].start_date).data.date_obj.year
            if (n < -271820 || 275759 < n) {
              this.scale = 'cosmological'
              break
            }
          }
      ...
      var a
      TL.DateUtil.SCALE_DATE_CLASSES[this.scale] ||
    ...
    getEarliestDate: function () {
      ...
      return this.eras && 0 < this.eras.length && this.eras[0].start_date.isBefore(t)
    ...
    _tidyFields: function (t) {
      ...
      t.group && (t.group = TL.Util.trim(t.group)),
        t.text || (t.text = {}),
        e(t.text, 'text'),
        e(t.text, 'headline')
    }
  ...
  (function (h) {
    function o(t) {
      ...
      if (t.match(e)) parts.key = t.match(e)[1]
        ...
        var n = t.search(i) + t.match(i)[0].length,
          a = t.substr(n)
        ;(parts.key = a.split('/')[0]),
          t.match(/\?gid=(\d+)/) && (parts.worksheet = t.match(/\?gid=(\d+)/)[1])
      } else t.match(/^\b[-_A-Za-z0-9]+$/) && (parts.key = t)
      return parts.key ? parts : null
    }
    function n(t) {
      var e = {}
      for (k in t) 0 == k.indexOf('gsx$') && (e[k.substr(4)] = t[k].$t)
      if (h.Util.isEmptyObject(e)) return null
      var i = {
        media: {
      ...
      return (
        e.startdate && (i.start_date = h.Date.parseDate(e.startdate)),
        e.enddate && (i.end_date = h.Date.parseDate(e.enddate)),
        i
      )
    }
    function a(t) {
      ...
      var i = {}
      for (k in t) 0 == k.indexOf('gsx$') && (i[k.substr(4)] = h.Util.trim(t[k].$t))
      if (h.Util.isEmptyObject(i)) return null
      var n = {
        media: {
        ...
        text: { headline: i.headline || '', text: i.text || '' },
        start_date: { year: e(i.year), month: e(i.month) || '', day: e(i.day) || '' },
        end_date: { year: e(i.endyear) || '', month: e(i.endmonth) || '', day: e(i.endday) || '' },
        display_date: i.displaydate || '',
        type: i.type || ''
      }
      if (
        (i.time && h.Util.mergeData(n.start_date, h.DateUtil.parseTime(i.time)),
        i.endtime && h.Util.mergeData(n.end_date, h.DateUtil.parseTime(i.endtime)),
        i.group && (n.group = i.group),
        '' == n.end_date.year)
      ) {
        var a = n.end_date
        if ((delete n.end_date, '' != a.month || '' != a.day || '' != a.time)) {
          var s =
            n.text.headline ||
            trace(
              'Invalid end date for spreadsheet row. Must have a year if any other date fields are specified.'
            )
          trace(t)
        }
      }
      return (
        i.background &&
          (i.background.match(/^(https?:)?\/\/?/)
            ? (n.background = { url: i.background })
            : (n.background = { color: i.background })),
        n
      )
    }
    function s(t, e) {
      ...
      for (var n = {}, a = 1; a < e.length; a++) {
        var s
        if (t.length >= a) n[t[a].toLowerCase().replace(' ', '')] = e[a]
      }
      var o = {
        media: {
      ...
      if (
        (n.time && h.Util.mergeData(o.start_date, h.DateUtil.parseTime(e[3])),
        n.endtime && h.Util.mergeData(o.end_date, h.DateUtil.parseTime(n.endtime)),
        n.group && (o.group = n.group),
        '' == o.end_date.year)
      ) {
        var r = o.end_date
        if ((delete o.end_date, '' != r.month || '' != r.day || '' != r.time)) {
          var l =
            o.text.headline ||
            trace(
              'Invalid end date for spreadsheet row. Must have a year if any other date fields are specified.'
      ...
      return (
        ...
        n.background &&
          (n.background.match(/^(https?:)?\/\/?/)
            ? (o.background = { url: n.background })
            : (o.background = { color: n.background })),
        o
      )
    }
    var t = function (t) {
        if (void 0 === t.feed.entry || 0 == t.feed.entry.length) throw new h.Error('empty_feed_err')
        var e = t.feed.entry[0]
        if (void 0 !== e.gsx$startdate) return n
        if (void 0 === e.gsx$year) throw new h.Error('invalid_data_format_err')
        var i = [
          'month',
          'day',
          'time',
      ...
      l = function (t) {
        var t = r(o(t)),
          e = { events: [] },
          i = h.ajax({ url: t, async: !1 })
        return (i = JSON.parse(i.responseText)), d(i)
      },
      d = function (t) {
        for (
          var e = { events: [], errors: [], warnings: [], eras: [] }, i = 1;
          i < t.values.length;
          i++
        ) {
          var n = s(t.values[0], t.values[i])
          if (n) {
            var a = 'event'
            void 0 !== n.type && ((a = n.type), delete n.type),
              'title' == a
                ? e.title
                  ? (e.warnings.push('Multiple title slides detected.'), e.events.push(n))
                  : (e.title = n)
                : 'era' == a
                ? e.eras.push(n)
                : e.events.push(n)
      ...
      e = function (t, n) {
        ...
        if (o(t)) {
          try {
            ...
            return (
              (a = new h.TimelineConfig()),
              'NetworkError' == t.name
                ? a.logError(new h.Error('network_err'))
                : 'TL.Error' == t.name
                ? a.logError(t)
                : a.logError(new h.Error('unknown_read_err', t.name)),
              void n(a)
            )
          }
          if (((a = new h.TimelineConfig(i)), i.errors))
            for (var s = 0; s < i.errors.length; s++) a.logError(i.errors[s])
          n(a)
        } else
          h.ajax({
            url: t,
            ...
            success: function (t) {
              try {
                a = new h.TimelineConfig(t)
              } catch (t) {
                ;(a = new h.TimelineConfig()).logError(t)
              }
              n(a)
            },
            error: function (t, e, i) {
              if (((a = new h.TimelineConfig()), 'parsererror' == e))
                var i = new h.Error('invalid_url_err')
              else var i = new h.Error('unknown_read_err', e)
              a.logError(i), n(a)
            }
          })
      }
    h.ConfigFactory = {
      ...
      googleFeedJSONtoTimelineJSON: d,
      fromGoogle: function (t) {
        return (
          console.warn(
            'TL.ConfigFactory.fromGoogle is deprecated and will be removed soon. Use TL.ConfigFactory.makeConfig(url,callback)'
          ),
          l(t)
        )
      },
  ...
  (TL.Language = function (t) {
    ...
    if (t && t.language && 'string' == typeof t.language && 'en' != t.language) {
      ...
      if (!(e in TL.Language.languages)) {
        ...
        var s = this,
          o = TL.ajax({ url: i, async: !1 })
        if (200 != o.status) throw 'Could not load language [' + e + ']: ' + o.statusText
        TL.Language.languages[e] = JSON.parse(o.responseText)
      }
  ...
  (TL.Language.prototype.mergeData = function (t) {
    for (k in TL.Language.languages.en)
      t[k] && ('object' == typeof this[k] ? TL.Util.mergeData(t[k], this[k]) : (this[k] = t[k]))
  }),
  ...
  (TL.Language.prototype.formatDate = function (t, e) {
    return t.constructor == Date
      ? this.formatJSDate(t, e)
      : t.constructor == TL.BigYear
      ? this.formatBigYear(t, e)
      : t.data && t.data.date_obj
      ? this.formatDate(t.data.date_obj, e)
      : (trace('Unfamiliar date presented for formatting'), t.toString())
  }),
  (TL.Language.prototype.formatBigYear = function (t, e) {
    ...
    if (n) {
      for (var a = 0; a < n.length; a++) {
        var s = n[a]
        if (1 < Math.abs(i / s[0])) return TL.Language.formatNumber(Math.abs(i / s[0]), s[1])
      }
      return i.toString()
    }
    return (
      trace('Language file dateformats missing cosmological. Falling back.'),
      TL.Language.formatNumber(i, e)
    )
  }),
  (TL.Language.prototype.formatJSDate = function (t, e) {
    var n = this,
      i = function (t, e) {
        var i = n.period_labels[t]
        if (i) var t = e < 12 ? i[0] : i[1]
    ...
    var l = 'get',
      ...
      y = {
        ...
        ss: TL.Util.pad(p),
        l: TL.Util.pad(f, 3),
        L: TL.Util.pad(99 < f ? Math.round(f / 10) : f),
        t: i('t', m),
        tt: i('tt', m),
        T: i('T', m),
        TT: i('TT', m),
        Z: (String(t).match(s) || ['']).pop().replace(o, ''),
        o:
          (0 < g ? '-' : '+') +
          TL.Util.pad(100 * Math.floor(Math.abs(g) / 60) + (Math.abs(g) % 60), 4),
        S: ['th', 'st', 'nd', 'rd'][3 < h % 10 ? 0 : (((h % 100) - (h % 10) != 10) * h) % 10]
      },
      T = r.replace(TL.Language.DATE_FORMAT_TOKENS, function (t) {
        return t in y ? y[t] : t.slice(1, t.length - 1)
      })
    return this._applyEra(T, u)
  }),
  ...
  (TL.I18NMixins = {
    getLanguage: function () {
      return this.options && this.options.language
        ? this.options.language
        : (trace('Expected a language option'), TL.Language.fallback)
    },
    _: function (t) {
  ...
  (TL.Ease = {
    KeySpline: function (s) {
      ...
      this.get = function (t) {
        return s[0] == s[1] && s[2] == s[3] ? t : r(e(t), s[1], s[3])
      }
    },
    easeInSpline: function (t) {
      var e
      return new TL.Ease.KeySpline(TL.Easings.easein).get(t)
    },
    ...
    flicker: function (t) {
      ...
      return easings.sinusoidal(t < 0 ? 0 : 1 < t ? 1 : t)
    },
    mirror: function (t) {
      return t < 0.5 ? easings.sinusoidal(2 * t) : easings.sinusoidal(1 - 2 * (t - 0.5))
    },
  ...
  (window.tlanimate = (function () {
    ...
    function a(t) {
      var e,
        i = P.length
      for (r && 1e12 < t && (t = g()), d && (t = g()), e = i; e--; ) P[e](t)
      P.length && O(a)
    }
    function e(t) {
      1 === P.push(t) && O(a)
    ...
    function _(t) {
      var e,
        i = n(P, t)
      0 <= i && ((e = P.slice(i + 1)), (P.length = i), (P = P.concat(e)))
    }
    function L(t, e) {
      var i = {},
        n
      return (
        (n = t.match(u)) && (i.rotate = S(n[1], e ? e.rotate : null)),
        (n = t.match(m)) && (i.scale = S(n[1], e ? e.scale : null)),
        (n = t.match(y)) &&
          ((i.skewx = S(n[1], e ? e.skewx : null)), (i.skewy = S(n[3], e ? e.skewy : null))),
        (n = t.match(T)) &&
          ((i.translatex = S(n[1], e ? e.translatex : null)),
          (i.translatey = S(n[3], e ? e.translatey : null))),
        i
      )
    }
    function w(t) {
    ...
    function M(t, i, n, a, s, o) {
      function r(t) {
        var e = t - c
        if (l < e || u)
          return (o = isFinite(o) ? o : 1), u ? m && i(o) : i(o), _(r), n && n.apply(h)
        isFinite(o) ? i(d * a(e / l) + s) : i(a(e / l))
      }
      a = x(a) ? a : f.easings[a] || p
      var l = t || v,
        h = this,
        d = o - s,
        c = g(),
    ...
    function D(t, e) {
      var i = t.length,
        ...
        a,
        s
      for (a = 0; a < i; ++a) n[a] = [t[a][0], t[a][1]]
      for (s = 1; s < i; ++s)
        for (a = 0; a < i - s; ++a)
          (n[a][0] = (1 - e) * n[a][0] + e * n[parseInt(a + 1, 10)][0]),
            (n[a][1] = (1 - e) * n[a][1] + e * n[parseInt(a + 1, 10)][1])
      return [n[0][0], n[0][1]]
    }
    function l(t, e, i) {
      var n = [],
        ...
        r
      for (a = 0; a < 6; a++)
        (o = Math.min(15, parseInt(e.charAt(a), 16))),
          (r = Math.min(15, parseInt(i.charAt(a), 16))),
          (s = 15 < (s = Math.floor((r - o) * t + o)) ? 15 : s < 0 ? 0 : s),
          (n[a] = s.toString(16))
      return '#' + n.join('')
    }
    function E(t, e, i, n, a, s, o) {
      if ('transform' != a)
        return 'string' == typeof i[s][a]
          ? l(t, i[s][a], n[s][a])
          : ((o = Math.round(((n[s][a] - i[s][a]) * t + i[s][a]) * v) / v),
            a in I || (o += e[s][a] || 'px'),
            o)
      for (var r in ((o = {}), i[s][a]))
        o[r] =
          r in n[s][a]
            ? Math.round(((n[s][a][r] - i[s][a][r]) * t + i[s][a][r]) * v) / v
            : i[s][a][r]
      return o
    }
    function S(t, e, i, n, a) {
      return (i = c.exec(t))
        ? (a = parseFloat(i[2])) && e + ('+' == i[1] ? 1 : -1) * a
        : parseFloat(t)
    }
    function f(t, a) {
      var s = t ? (s = isFinite(t.length) ? t : [t]) : [],
        o,
        e = a.complete,
        i = a.duration,
        n = a.easing,
      ...
      for (
        r &&
          ((u = a.left), (m = a.top), delete a.right, delete a.bottom, delete a.left, delete a.top),
          o = s.length;
        o--;
        ...
        if (((l[o] = {}), (h[o] = {}), (d[o] = {}), r)) {
          var _ = j(s[o], 'left'),
            p = j(s[o], 'top'),
            f = [
              S(x(u) ? u(s[o]) : u || 0, parseFloat(_)),
              S(x(m) ? m(s[o]) : m || 0, parseFloat(p))
            ]
          ;(c[o] = x(r) ? r(s[o], f) : r),
            c[o].push(f),
            c[o].unshift([parseInt(_, 10), parseInt(p, 10)])
        }
        for (var g in a) {
          switch (g) {
            case 'complete':
          ...
          var v = j(s[o], g),
            y,
            T = x(a[g]) ? a[g](s[o]) : a[g]
          'string' != typeof T || !C.test(T) || C.test(v)
            ? ((l[o][g] =
                'transform' == g
                  ? L(v)
                  : 'string' == typeof T && C.test(T)
                  ? b(v).slice(1)
                  : parseFloat(v)),
              (h[o][g] =
                'transform' == g
                  ...
                  ? b(T).slice(1)
                  : S(T, parseFloat(v))),
              'string' == typeof T && (y = T.match(N)) && (d[o][g] = y[1]))
            : delete a[g]
        }
      }
      return M.apply(s, [
        ...
        function (t, e, i) {
          for (o = s.length; o--; )
            for (var n in (r &&
              ((i = D(c[o], t)), (s[o].style.left = i[0] + 'px'), (s[o].style.top = i[1] + 'px')),
            a))
              (e = E(t, d, l, h, n, o)),
                'transform' == n
                  ? (s[o].style[U] = w(e))
                  : 'opacity' != n || A
                  ? (s[o].style[k(n)] = e)
                  : (s[o].style.filter = 'alpha(opacity=' + 100 * e + ')')
        },
        e,
        n
      ])
    ...
    var s = document,
      o = window,
      t = o.performance,
      r = t && (t.now || t.webkitNow || t.msNow || t.mozNow),
      g = r
        ? function () {
            return r.call(t)
          }
      ...
      C = /^rgb\(|#/,
      c = /^([+\-])=([\d\.]+)/,
      N = /^(?:[\+\-]=?)?\d+(?:\.\d+)?(%|in|cm|mm|em|ex|pt|pc|px)$/,
      u = /rotate\(((?:[+\-]=)?([\-\d\.]+))deg\)/,
      m = /scale\(((?:[+\-]=)?([\d\.]+))\)/,
      y = /skew\(((?:[+\-]=)?([\-\d\.]+))deg, ?((?:[+\-]=)?([\-\d\.]+))deg\)/,
      T = /translate\(((?:[+\-]=)?([\-\d\.]+))px, ?((?:[+\-]=)?([\-\d\.]+))px\)/,
      I = { lineHeight: 1, zoom: 1, zIndex: 1, opacity: 1, transform: 1 },
      U = (function () {
        var t = s.createElement('a').style,
          e = ['webkitTransform', 'MozTransform', 'OTransform', 'msTransform', 'Transform'],
          i
        for (i = 0; i < e.length; i++) if (e[i] in t) return e[i]
      })(),
      A = void 0 !== s.createElement('a').style.opacity,
      j =
        s.defaultView && s.defaultView.getComputedStyle
          ? function (t, e) {
              e = k((e = 'transform' == e ? U : e))
              var i = null,
          ...
          ? function (e, t) {
              if ('opacity' == (t = k(t))) {
                var i = 100
                try {
                  i = e.filters['DXImageTransform.Microsoft.Alpha'].opacity
                } catch (t) {
                  try {
                    i = e.filters('alpha').opacity
                  } catch (t) {}
                }
                return i / 100
              }
  ...
  (TL.Dom = {
    ...
    setPosition: function (t, e) {
      ;(t._tl_pos = e),
        TL.Browser.webkit3d
          ? ((t.style[TL.Dom.TRANSFORM] = TL.Dom.getTranslateString(e)),
            TL.Browser.android &&
              ((t.style['-webkit-perspective'] = '1000'),
  ...
  (TL.DomUtil = {
    ...
    getViewportOffset: function (t) {
      ...
      do {
        if (
          ((e += n.offsetTop || 0),
          (i += n.offsetLeft || 0),
          n.offsetParent === a && 'absolute' === TL.DomUtil.getStyle(n, 'position'))
        )
          break
        n = n.offsetParent
      } while (n)
    ...
    hasClass: function (t, e) {
      return 0 < t.className.length && new RegExp('(^|\\s)' + e + '(\\s|$)').test(t.className)
    },
    ...
    setOpacity: function (t, e) {
      TL.Browser.ie
        ? (t.style.filter = 'alpha(opacity=' + Math.round(100 * e) + ')')
        : (t.style.opacity = e)
    },
    testProp: function (t) {
      for (var e = document.documentElement.style, i = 0; i < t.length; i++)
    ...
    getScaleString: function (t, e) {
      var i, n, a
      return (
        TL.DomUtil.getTranslateString(e) +
        (' scale(' + t + ') ') +
        TL.DomUtil.getTranslateString(e.multiplyBy(-1))
      )
    },
    setPosition: function (t, e) {
      ;(t._tl_pos = e),
        TL.Browser.webkit3d
          ? ((t.style[TL.DomUtil.TRANSFORM] = TL.DomUtil.getTranslateString(e)),
            TL.Browser.android &&
              ((t.style['-webkit-perspective'] = '1000'),
              (t.style['-webkit-backface-visibility'] = 'hidden')))
          : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px'))
  ...
  (TL.DomEvent = {
    addListener: function (e, t, i, n) {
      ...
      if (!e[s]) {
        var o = function (t) {
          return i.call(n || e, t || TL.DomEvent._getEvent())
        }
        if (TL.Browser.touch && 'dblclick' === t && this.addDoubleTapListener)
          this.addDoubleTapListener(e, o, a)
        else if ('addEventListener' in e)
          if ('mousewheel' === t)
            e.addEventListener('DOMMouseScroll', o, !1), e.addEventListener(t, o, !1)
          else if ('mouseenter' === t || 'mouseleave' === t) {
            var r = o,
              l = 'mouseenter' === t ? 'mouseover' : 'mouseout'
            ;(o = function (t) {
              if (TL.DomEvent._checkMouse(e, t)) return r(t)
            }),
              e.addEventListener(l, o, !1)
          } else e.addEventListener(t, o, !1)
        else 'attachEvent' in e && e.attachEvent('on' + t, o)
        e[s] = o
      }
    },
    removeListener: function (t, e, i) {
      var n = TL.Util.stamp(i),
        ...
        s = t[a]
      s &&
        (TL.Browser.touch && 'dblclick' === e && this.removeDoubleTapListener
          ? this.removeDoubleTapListener(t, n)
          : 'removeEventListener' in t
          ? 'mousewheel' === e
            ? (t.removeEventListener('DOMMouseScroll', s, !1), t.removeEventListener(e, s, !1))
            : 'mouseenter' === e || 'mouseleave' === e
            ? t.removeEventListener('mouseenter' === e ? 'mouseover' : 'mouseout', s, !1)
    ...
    disableClickPropagation: function (t) {
      TL.DomEvent.addListener(t, TL.Draggable.START, TL.DomEvent.stopPropagation),
        TL.DomEvent.addListener(t, 'click', TL.DomEvent.stopPropagation),
        TL.DomEvent.addListener(t, 'dblclick', TL.DomEvent.stopPropagation)
    },
  ...
  (TL.StyleSheet = TL.Class.extend({
    ...
    addRule: function (t, e, i) {
      var n = 0
      i && (n = i),
        'insertRule' in this.sheet
          ? this.sheet.insertRule(t + '{' + e + '}', n)
          : 'addRule' in this.sheet && this.sheet.addRule(t, e, n)
    },
    onLoaded: function (t) {
  ...
  (TL.Date = TL.Class.extend({
    ...
    getDisplayDate: function (t, e) {
      ...
      t || (t = TL.Language.fallback),
        t.constructor != TL.Language &&
          (trace('First argument to getDisplayDate must be TL.Language'),
          (t = TL.Language.fallback))
    ...
    _getDateData: function () {
      ...
      for (var i in e) {
        var n
        if (!TL.Util.trim(t[e[i]]).match(/^-?\d*$/))
          throw new TL.Error('invalid_date_err', e[i] + " = '" + t[e[i]] + "'")
        var a = parseInt(t[e[i]])
        isNaN(a) && (a = 4 == i || 5 == i ? 1 : 0), (t[e[i]] = a)
      }
      return 0 < t.month && t.month <= 12 && (t.month = t.month - 1), t
    },
    ...
    findBestFormat: function (t) {
      for (var e = TL.Date.DATE_PARTS, i = '', n = 0; n < e.length; n++)
        if (this.data[e[n]])
          return (
            t ? t in TL.Date.BEST_DATEFORMATS || (t = 'short') : (t = 'base'),
            TL.Date.BEST_DATEFORMATS[t][e[n]]
          )
      return ''
    },
  ...
  (function (r) {
    ;(r.SCALES = [
      ...
      (r.DATE_PARTS = ['millisecond', 'second', 'minute', 'hour', 'day', 'month', 'year'])
    var l = /^([\+-]?\d+?)(-\d{2}?)?(-\d{2}?)?$/,
      h = /^([\+-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d+(?!:))?)?(\17[0-5]\d([\.,]\d+)?)?([zZ]|([\+-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$/
    ;(r.parseISODate = function (t) {
      var e = new Date(t)
      ...
      (r.parseDate = function (t) {
        if (t.match(l)) {
          var e = t.match(l).slice(1),
            i = { year: e[0].replace('+', '') }
          return (
            e[1] && (i.month = e[1].replace('-', '')), e[2] && (i.day = e[2].replace('-', '')), i
          )
        }
        if (t.match(h)) return r.parseISODate(t)
        if (t.match(/^\-?\d+$/)) return { year: t }
        var n = {}
        if (t.match(/\d+\/\d+\/\d+/)) {
          var a = t.match(/\d+\/\d+\/\d+/)[0]
          t = TL.Util.trim(t.replace(a, ''))
          var s = a.split('/')
          ;(n.month = s[0]), (n.day = s[1]), (n.year = s[2])
        }
        if (t.match(/\d+\/\d+/)) {
          var a = t.match(/\d+\/\d+/)[0]
          t = TL.Util.trim(t.replace(a, ''))
          var s = a.split('/')
          ;(n.month = s[0]), (n.year = s[1])
        }
        if (t.match(':')) {
          var o = t.split(':')
          ;(n.hour = o[0]),
            (n.minute = o[1]),
            o[2] &&
              ((second_parts = o[2].split('.')),
              (n.second = second_parts[0]),
              (n.millisecond = second_parts[1]))
        }
        return n
      }),
      (r.BEST_DATEFORMATS = {
  ...
  (function (t) {
    var e = 1e6,
      ...
      s = function (i) {
        return function (t) {
          var e = t.getTime()
          return new TL.BigYear(Math.floor(e / i) * i)
        }
      }
    t.SCALES = [
      ['year', 1, new s(1)],
  ...
  (TL.DateUtil = {
    ...
    sortByDate: function (t, i) {
      var i = i || 'start_date'
      t.sort(function (t, e) {
        return t[i].isBefore(e[i]) ? -1 : t[i].isAfter(e[i]) ? 1 : 0
      })
    },
    parseTime: function (t) {
      ...
      if (
        (s ? (a = s.slice(1)) : 1 == (a = t.split(':')).length && (a = t.split('.')), 4 < a.length)
      )
      ...
      if (
        ...
        isNaN(e.hour) || e.hour < 0 || 23 < e.hour)
      )
        throw new TL.Error('invalid_hour_err', e.hour)
      if (1 < a.length && ((e.minute = parseInt(a[1])), isNaN(e.minute)))
        throw new TL.Error('invalid_minute_err', e.minute)
      if (2 < a.length) {
        var o
        if (2 < (a = a[2].split(/[\.,]/).concat(a.slice(3))).length)
  ...
  (TL.Draggable = TL.Class.extend({
    ...
    initialize: function (t, e, i) {
      ;(this._el = { drag: t, move: t }),
        ...
        TL.Browser.touch && (this.dragevent = this.touchdrag),
        (this.data = {
          sliding: !1,
          direction: 'none',
          pagex: { start: 0, end: 0 },
    ...
    _momentum: function () {
      ...
      TL.Browser.touch,
        ...
        e.time < 3e3 && (i = !0),
        1e4 < Math.abs(e.x) &&
          ((this.data.direction = 'left'), 0 < e.x && (this.data.direction = 'right')),
        1e4 < Math.abs(e.y) &&
          ((this.data.direction = 'up'), 0 < e.y && (this.data.direction = 'down')),
    ...
    _animateMomentum: function () {
      ...
      this.options.enable.y &&
        ...
        (this.animator = TL.Animate(this._el.move, e)),
  ...
  (TL.MenuBar = TL.Class.extend({
    ...
    _initLayout: function () {
      ;(this._el.button_zoomin = TL.Dom.create('span', 'tl-menubar-button', this._el.container)),
        ...
        (this._el.button_backtostart = TL.Dom.create(
          'span',
          'tl-menubar-button',
          this._el.container
        )),
        TL.Browser.mobile && this._el.container.setAttribute('ontouchstart', ' '),
  ...
  (TL.Message = TL.Class.extend({
    ...
    _initLayout: function () {
      ;(this._el.message_container = TL.Dom.create(
        'div',
        'tl-message-container',
        this._el.container
      )),
        (this._el.loading_icon = TL.Dom.create(
          'div',
  ...
  (TL.MediaType = function (t, e) {
    var i = {},
      n = [
        ...
        { type: 'iframe', name: 'iFrame', match_str: 'iframe', cls: TL.Media.IFrame },
        { type: 'storify', name: 'Storify', match_str: 'storify', cls: TL.Media.Storify },
        { type: 'blockquote', name: 'Quote', match_str: 'blockquote', cls: TL.Media.Blockquote },
  ...
  (TL.Media = TL.Class.extend({
    ...
    loadErrorDisplay: function (t) {
      ...
      ;(this._el.content_item = TL.Dom.create(
        'div',
      ...
      ;(this._state.show_meta = !0),
        this.data.credit &&
          ...
          (this._el.credit.innerHTML =
            1 == this.options.autolink ? TL.Util.linkify(this.data.credit) : this.data.credit),
          (this.options.credit_height = this._el.credit.offsetHeight)),
        this.data.caption &&
          '' != this.data.caption &&
          ((this._el.caption = TL.Dom.create('div', 'tl-caption', this._el.content_container)),
          (this._el.caption.innerHTML =
            1 == this.options.autolink ? TL.Util.linkify(this.data.caption) : this.data.caption),
    ...
    _initLayout: function () {
      ;(this.message = new TL.Message({}, this.options)),
        ...
        (this._el.content_container = TL.Dom.create(
          'div',
        ...
        this.data.link && '' != this.data.link
          ...
          : (this._el.content = TL.Dom.create(
              'div',
              'tl-media-content',
  ...
  (TL.Media.DailyMotion = TL.Media.extend({
    ...
    _updateMediaDisplay: function () {
      this._el.content_item.style.height =
        TL.Util.ratio.r16_9({ w: this._el.content_item.offsetWidth }) + 'px'
    },
    _stopMedia: function () {
    ...
    _loadMedia: function () {
      ...
      ;(this._el.content_item = TL.Dom.create(
        ...
        this.data.url.match(/\.html$/)
          ...
          : this.data.url.match(/.(json|js)$/) || trace('DOCUMENT CLOUD IN URL BUT INVALID SUFFIX'),
        TL.Load.js(
          [
  ...
  (TL.Media.Flickr = TL.Media.extend({
    ...
    createMedia: function () {
      ...
      ;(this._el.content_link = TL.Dom.create('a', '', this._el.content)),
        ...
        this.data.alt
          ...
          : this.data.caption && (this._el.content_item.alt = TL.Util.unhtmlify(this.data.caption)),
        this.data.title
    ...
    getImageURL: function (t, e) {
      for (
        var i = this.size_label(e), n = this.sizes[this.sizes.length - 2].source, a = 0;
        a < this.sizes.length;
        a++
      )
      ...
      ;(t =
        ...
        TL.getJSON(t, function (t) {
          ;(e.data.credit_alternate =
            "<a href='" + e.data.url + "' target='_blank'>" + t.photo.owner.realname + '</a>'),
    ...
    _loadMedia: function () {
      ...
      if (
        ...
        (this.media_id = this.data.url.split('open?id=')[1]),
          this.data.url.match('&authuser=0') && (t = this.media_id.match('&authuser=0')[0])
  ...
  (TL.Media.GooglePlus = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      ;(this._el.content_item = TL.Dom.create(
        'div',
        'tl-media-item tl-media-googleplus',
        this._el.content
      )),
        (this.media_id = this.data.url),
        (t = this.media_id),
        (this._el.content_item.innerHTML =
          "<iframe frameborder='0' width='100%' height='100%' src='" + t + "'></iframe>"),
        this.onLoaded()
    },
    _updateMediaDisplay: function () {
      this._el.content_item.style.height = this.options.height + 'px'
  ...
  (TL.Media.Image = TL.Media.extend({
    ...
    createMedia: function () {
      var e = this,
        t = 'tl-media-item tl-media-image tl-media-shadow'
      ;(this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) &&
        (t = 'tl-media-item tl-media-image'),
        this.data.link
          ? ((this._el.content_link = TL.Dom.create('a', '', this._el.content)),
            (this._el.content_link.href = this.data.link),
            (this._el.content_link.target = '_blank'),
            (this._el.content_item = TL.Dom.create('img', t, this._el.content_link)))
          : (this._el.content_item = TL.Dom.create('img', t, this._el.content)),
        this.data.alt
          ? (this._el.content_item.alt = this.data.alt)
          : this.data.caption && (this._el.content_item.alt = TL.Util.unhtmlify(this.data.caption)),
        this.data.title
  ...
  (TL.Media.Imgur = TL.Media.extend({
    ...
    createMedia: function () {
      var n = this,
        t = 'https://api.imgur.com/oembed.json?url=' + this.data.url
      ;(this._el.content_item = TL.Dom.create(
        'div',
        ...
        TL.ajax({
          ...
          success: function (t) {
            try {
              ;(n._el.content_item.innerHTML = t.html),
          ...
          error: function (t, e, i) {
            if (((tc = new TL.TimelineConfig()), 'parsererror' == e))
              var i = new TL.Error('invalid_url_err')
            else var i = new TL.Error('unknown_read_err', e)
            n.loadErrorDisplay(n._('imgur_invalidurl_err')), tc.logError(i)
          }
        }),
        this.onLoaded()
    },
  ...
  (TL.Media.Instagram = TL.Media.extend({
    ...
    _getMeta: function () {
      var e = this,
        t
      ;(t =
        'https://api.instagram.com/oembed?url=https://instagr.am/p/' +
        this.media_id +
        '&callback=?'),
        TL.getJSON(t, function (t) {
          ;(e.data.credit_alternate =
            "<a href='" + t.author_url + "' target='_blank'>" + t.author_name + '</a>'),
            (e.data.caption_alternate = t.title),
            e.updateMeta()
        })
    },
    sizes: function (t) {
  ...
  (TL.Media.GoogleMap = TL.Media.extend({
    ...
    _loadMedia: function () {
      ;(this._el.content_item = TL.Dom.create(
        ...
        ((window.stash = this).mapframe.width = '100%'),
    ...
    makeGoogleMapsEmbedURL: function (t, r) {
      function e(a) {
        function o(t, e) {
          if ('z' == t.slice(-1)) e.zoom = t
          else if ('m' == t.slice(-1)) (e.zoom = 14), (e.maptype = 'satellite')
          else if ('t' == t.slice(-1)) {
            if (((l = !0), 'place' == mapmode))
              var i = a.match(d.place)[3] + ',' + a.match(d.place)[4]
            else {
              var i = e.center
              delete e.center
            }
            for (param in (((e = {}).location = i),
            (streetview_params = t.split(',')),
            h.streetview)) {
              var n = parseInt(param) + 1
              'pitch' == h.streetview[param] && '90t' == streetview_params[n]
                ? (e[h.streetview[param]] = 0)
                : (e[h.streetview[param]] = streetview_params[n].slice(0, -1))
            }
          }
          return e
        }
        function t(t, e) {
          ...
          return (
            ((i = o(a, i)).key = r),
            1 == l && (t = 'streetview'),
            n + '/embed/v1/' + t + TL.Util.getParamString(i)
          )
        }
        return (
          (mapmode = 'view'),
          a.match(d.place)
            ? (mapmode = 'place')
            : a.match(d.directions)
            ? (mapmode = 'directions')
            : a.match(d.search) && (mapmode = 'search'),
          t(mapmode, a.match(d[mapmode]))
        )
      }
      var l = !1,
        h = {
        ...
        o = /,((?:[-\d.]+[zmayht],?)*)/,
        d = {
          view: new RegExp(i.source + '/' + n.source + o.source),
          place: new RegExp(i.source + '/place/' + a.source + '/' + n.source + o.source),
          directions: new RegExp(
            i.source + '/dir/' + a.source + '/' + a.source + '/' + n.source + o.source
          ),
          search: new RegExp(i.source + '/search/' + a.source + '/' + n.source + o.source)
        }
      return e(t)
    }
  })),
  (TL.Media.PDF = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      var i = ''
      ;(i =
        TL.Browser.ie || TL.Browser.edge || t.match(/dl.dropboxusercontent.com/)
...
;(TL.Media.SoundCloud = TL.Media.extend({
  ...
  (TL.Media.Spotify = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      if (
        ...
        (this.data.url.match(/^spotify:track/) ||
          this.data.url.match(/^spotify:album/) ||
          this.data.url.match(/^spotify:user:.+:playlist:/)) &&
          (this.media_id = this.data.url),
        ...
        var i = this.data.url.match(/spotify\.com\/user\/(.+?)\/playlist\/(.+)/)[1],
          n = this.data.url.match(/spotify\.com\/user\/(.+?)\/playlist\/(.+)/)[2]
        this.media_id = 'spotify:user:' + i + ':playlist:' + n
      } else if (this.data.url.match(/spotify\.com\/artist\/(.+)/)) {
        var a = this.data.url.match(/spotify\.com\/artist\/(.+)/)[1]
        this.media_id = 'spotify:artist:' + a
      }
      this.media_id
  ...
  (TL.Media.Storify = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      ;(this._el.content_item = TL.Dom.create(
        'div',
        'tl-media-item tl-media-iframe tl-media-storify',
        this._el.content
      )),
        (this.media_id = this.data.url),
        (t =
          ...
          this.media_id +
          "/embed'></iframe>"),
        (t += "<script src='" + this.media_id + ".js'></script>"),
        (this._el.content_item.innerHTML = t),
        this.onLoaded()
    },
    _updateMediaDisplay: function () {
    ...
    _initLayout: function () {
      if (
        ...
        this.options.title && (t = 'tl-headline tl-headline-title'),
          (this._el.headline = TL.Dom.create('h2', t, this._el.content_container)),
          (this._el.headline.innerHTML = this.data.headline)
      }
      if ('' != this.data.text) {
        var e = ''
        ;(e += TL.Util.htmlify(
          1 == this.options.autolink ? TL.Util.linkify(this.data.text) : this.data.text
        )),
  ...
  (TL.Media.Twitter = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      if (
        ...
        var e = this.data.url.match(/(status|statuses)\/(\d+)/)
        if (!(e && 2 < e.length)) return void n.loadErrorDisplay(n._('twitterembed_invalidurl_err'))
        this.media_id = e[2]
      }
      ;(t =
        ...
        TL.ajax({
          ...
          error: function (t, e) {
            var i = ''
            ;(i += n._('twitter_load_err') + '<br/>' + n.media_id + '<br/>' + e),
              n.loadErrorDisplay(i)
          }
        })
    },
    createMedia: function (t) {
      ...
      var e = '',
        ...
        o = '',
        r = this
      ;(i = t.html.split('</p>&mdash;')[0] + '</p></blockquote>'),
        (n = t.author_url.split('twitter.com/')[1]),
        (s = (a = t.html.split('</p>&mdash;')[1].split('<a href="')[1]).split('">')[0]),
        (o = a.split('">')[1].split('</a>')[0]),
        (i = i.replace(/<a href/gi, '<a target="_blank" href')).includes('pic.twitter.com')
          ...
          : ((e += i),
            (e += "<div class='vcard'>"),
            (e += "<a href='" + s + "' class='twitter-date' target='_blank'>" + o + '</a>'),
            (e += "<img src='' class='tl-media-item tl-media-image' target='_blank'></a>"),
            (e += "<div class='author'>"),
            (e += "<a class='screen-name url' href='" + t.author_url + "' target='_blank'>"),
            (e += "<span class='avatar'></span>"),
            (e +=
              "<span class='fn'>" +
              t.author_name +
              " <span class='tl-icon-twitter'></span></span>"),
            (e += "<span class='nickname'>@" + n + "<span class='thumbnail-inline'></span></span>"),
            (e += '</a>'),
            (e += '</div>'),
            (e += '</div>'),
  ...
  (TL.Media.TwitterEmbed = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      e && 2 < e.length
        ...
        : n.loadErrorDisplay(n._('twitterembed_invalidurl_err'))
    },
    createMedia: function (t) {
      trace('create_media')
      var i = '',
        ...
        s = '',
        o = ''
      ;(e = t.html.split('</p>&mdash;')[0] + '</p></blockquote>'),
        console.log(e),
        (n = t.author_url.split('twitter.com/')[1]),
        (s = (a = t.html.split('</p>&mdash;')[1].split('<a href="')[1]).split('">')[0]),
        (o = a.split('">')[1].split('</a>')[0]),
        (e = e.replace(/<a href/gi, '<a target="_blank" href')).includes('pic.twitter.com')
          ? twttr.ready(function (t) {
              i = document.getElementsByClassName('tl-media-twitter')[0]
              var e = String(mediaID)
              twttr.widgets
                .createTweet(e, i, { conversation: 'none', linkColor: '#cc0000', theme: 'light' })
                .then(function (t) {
                  this.onLoaded()
                })
            })
          : ((i += e),
            (i += "<div class='vcard'>"),
            (i += "<a href='" + s + "' class='twitter-date' target='_blank'>" + o + '</a>'),
            (i += "<div class='author'>"),
            (i += "<a class='screen-name url' href='" + t.author_url + "' target='_blank'>"),
            (i += "<span class='avatar'></span>"),
            (i +=
              "<span class='fn'>" +
              t.author_name +
              " <span class='tl-icon-twitter'></span></span>"),
            (i += "<span class='nickname'>@" + n + "<span class='thumbnail-inline'></span></span>"),
            (i += '</a>'),
            (i += '</div>'),
            (i += '</div>')),
        (this._el.content_item.innerHTML = i),
  ...
  (TL.Media.Website = TL.Media.extend({
    ...
    createMedia: function (t) {
      var e = ''
      ;(e += "<h4><a href='" + this.data.url + "' target='_blank'>" + t.title + '</a></h4>'),
        t.images &&
          t.images[0] &&
          (trace(t.images[0].url), (e += "<img src='" + t.images[0].url + "' />")),
        t.favicon_url && (e += "<img class='tl-media-website-icon' src='" + t.favicon_url + "' />"),
        (e += "<span class='tl-media-website-description'>" + t.provider_name + '</span><br/>'),
        (e += '<p>' + t.description + '</p>'),
        this._setContent(e)
    },
    _setContent: function (t) {
      ;(this._el.content_item = TL.Dom.create(
        'div',
        'tl-media-item tl-media-website',
        this._el.content
      )),
        (this._el.content_container.className =
          'tl-media-content-container tl-media-content-container-text'),
    ...
    _loadMedia: function () {
      ...
      ;(this._el.content_item = TL.Dom.create(
        ...
        TL.ajax({
          ...
          error: function (t, e) {
            var i = ''
            ;(i += n._('wikipedia_load_err') + '<br/>' + n.media_id + '<br/>' + e),
              n.loadErrorDisplay(i)
          }
        })
    },
    createMedia: function (t) {
      ...
      if (t.query) {
        ...
        ;((e = {
          ...
          page_image: '',
          text_array: []
        }).entry = TL.Util.getObjectAttributeByIndex(t.query.pages, 0)),
  ...
  (TL.Media.YouTube = TL.Media.extend({
    ...
    _loadMedia: function () {
      ...
      ;(this.youtube_loaded = !1),
        ...
        (this.media_id.hd = Boolean(void 0 !== e.hd)),
  ...
  (TL.Media.Audio = TL.Media.extend({
    ...
    createMedia: function () {
      var e = this,
        t = 'tl-media-item tl-media-audio tl-media-shadow'
      this.data.link
        ? ((this._el.content_link = TL.Dom.create('a', '', this._el.content)),
          (this._el.content_link.href = this.data.link),
          (this._el.content_link.target = '_blank'),
          (this._el.content_item = TL.Dom.create('audio', t, this._el.content_link)))
        : (this._el.content_item = TL.Dom.create('audio', t, this._el.content)),
  ...
  (TL.Media.Video = TL.Media.extend({
    ...
    createMedia: function () {
      var e = this,
        t = 'tl-media-item tl-media-video tl-media-shadow'
      this.data.link
        ? ((this._el.content_link = TL.Dom.create('a', '', this._el.content)),
          (this._el.content_link.href = this.data.link),
          (this._el.content_link.target = '_blank'),
          (this._el.content_item = TL.Dom.create('video', t, this._el.content_link)))
        : (this._el.content_item = TL.Dom.create('video', t, this._el.content)),
        (this._el.content_item.controls = !0),
        (this._el.source_item = TL.Dom.create('source', '', this._el.content_item)),
        this._el.content_item.addEventListener('load', function (t) {
          e.onMediaLoaded()
  ...
  (TL.Slide = TL.Class.extend({
    ...
    getFormattedDate: function () {
      if (0 < TL.Util.trim(this.data.display_date).length) return this.data.display_date
      var t = ''
      return (
        this.has.title ||
          (this.data.end_date &&
    ...
    _initLayout: function () {
      if (
        ...
        this.data.unique_id && (this._el.container.id = this.data.unique_id),
        (this._el.scroll_container = TL.Dom.create(
          'div',
    ...
    _updateDisplay: function (t, e, i) {
      ...
      ;(this.options.width = t || this._el.container.offsetWidth),
        ...
        TL.Browser.mobile && this.options.width <= this.options.skinny_size
          ? ((s = a = 0), (n = this.options.width))
          : 'landscape' == i ||
            (this.options.width <= this.options.skinny_size &&
              ((s = a = 50), (n = this.options.width - a - s))),
        (this._el.content.style.paddingLeft = a + 'px'),
        (this._el.content.style.paddingRight = s + 'px'),
  ...
  (TL.SlideNav = TL.Class.extend({
    ...
    _initLayout: function () {
      ;(this._el.content_container = TL.Dom.create(
        ...
        (this._el.description = TL.Dom.create(
          'div',
  ...
  (TL.StorySlider = TL.Class.extend({
    ...
    initialize: function (t, e, i, n) {
      ;(this._el = {
        ...
        'object' == typeof t
          ? ((this._el.container = t), (this.options.id = TL.Util.unique_ID(6, 'tl')))
          : ((this.options.id = t), (this._el.container = TL.Dom.get(t))),
        this._el.container.id || (this._el.container.id = this.options.id),
        (this.animator = null),
        TL.Util.mergeData(this.options, i),
        TL.Util.mergeData(this.data, e),
        n && this.init()
    },
    init: function () {
      this._initLayout(),
    ...
    _createSlides: function (t) {
      for (var e = 0; e < t.length; e++)
        '' == t[e].unique_id && (t[e].unique_id = TL.Util.unique_ID(6, 'tl-slide')),
    ...
    _findSlideIndex: function (t) {
      ...
      return (
        ('string' == typeof t || t instanceof String) &&
          (e = TL.Util.findArrayNumberByUniqueID(t, this._slides, 'unique_id')),
        e
      )
    },
    updateDisplay: function (t, e, i, n) {
    ...
    previous: function () {
      var t = this._findSlideIndex(this.current_id)
      0 <= t - 1 ? this.goTo(t - 1) : this.goTo(t)
    },
    ...
    changeBackground: function (t) {
      ...
      t.color_value && '' != t.color_value
        ? (e = TL.Util.hexToRgb(t.color_value)) ||
          (trace('Invalid color value ' + t.color_value), (e = this.options.default_bg_color))
    ...
    _updateDisplay: function (t, e, i, n) {
      var a, s
      ;(s = void 0 === n ? this.options.layout : n),
        (this.options.layout = s),
        (this.slide_spacing = 2 * this.options.width),
        (this.options.width = t || this._el.container.offsetWidth),
        (this.options.height = e || this._el.container.offsetHeight),
        (a = this.options.height / 2),
        this._nav.next.setPosition({ top: a }),
        this._nav.previous.setPosition({ top: a })
      for (var o = 0; o < this._slides.length; o++)
        this._slides[o].updateDisplay(this.options.width, this.options.height, s),
    ...
    _initLayout: function () {
      TL.DomUtil.addClass(this._el.container, 'tl-storyslider'),
        (this._el.slider_container_mask = TL.Dom.create(
          'div',
          'tl-slider-container-mask',
          this._el.container
        )),
        (this._el.background = TL.Dom.create(
          'div',
          'tl-slider-background tl-animate',
          this._el.container
        )),
        (this._el.slider_container = TL.Dom.create(
          'div',
          'tl-slider-container tlanimate',
          this._el.slider_container_mask
        )),
        (this._el.slider_item_container = TL.Dom.create(
          'div',
        ...
        TL.Browser.touch &&
          ((this._swipable = new TL.Swipable(
            this._el.slider_container_mask,
            this._el.slider_container,
      ...
      if (this._loaded) {
        ...
        ;(e = 'mouseenter' === e ? 'mouseover' : 'mouseleave' === e ? 'mouseout' : e),
          this.hasEventListeners(e) &&
            ('contextmenu' === e && TL.DomEvent.preventDefault(t),
  ...
  (TL.TimeNav = TL.Class.extend({
    ...
    _getTimeScale: function () {
      var e = 0
      try {
        e = parseInt(this.options.marker_height_min)
      } catch (t) {
        trace('Invalid value for marker_height_min option.'), (e = 30)
      }
      return (
        0 == e && (trace('marker_height_min option must not be zero.'), (e = 30)),
      ...
      if (this.options.has_groups)
        for (
          var t = this.options.height - this._el.timeaxis_background.offsetHeight,
            ...
            i = this.timescale.getGroupLabels(),
            n = 0,
            a = 0;
          n < this._groups.length;
          n++
        ) {
          var s = Math.floor(a * (e + this.options.marker_padding)),
            o = !1
          s > t - this.options.marker_padding && (o = !0),
            this._groups[n].setRowPosition(
              s,
              this._calculated_row_height + this.options.marker_padding / 2
            ),
            this._groups[n].setAlternateRowColor(TL.Util.isEven(n), o),
            (a += this._groups[n].data.rows)
        }
    },
    ...
    _findMarkerIndex: function (t) {
      ...
      return (
        ('string' == typeof t || t instanceof String) &&
          (e = TL.Util.findArrayNumberByUniqueID(t, this._markers, 'unique_id', e)),
        e
      )
    },
    ...
    _positionEras: function (t) {
      for (var e = 0, i = 0; i < this._eras.length; i++) {
        ...
        ;(n.start = this.timescale.getPosition(this._eras[i].data.start_date.getTime())),
          (n.end = this.timescale.getPosition(this._eras[i].data.end_date.getTime())),
    ...
    goTo: function (t, e, i) {
      ...
      this._resetMarkersActive(),
        0 <= t && t < this._markers.length && this._markers[t].setActive(!0),
        this.animator && this.animator.stop(),
        e
          ? ((this._el.slider.className = 'tl-timenav-slider'),
            (this._el.slider.style.left =
              -this._markers[o].getLeft() + this.options.width / 2 + 'px'))
          : i
    ...
    _onMouseScroll: function (t) {
      ...
      t || (t = window.event),
        ...
        (i = parseInt(this._el.slider.style.left.replace('px', '')) + e) > n.left
          ? (i = n.left)
          : i < n.right && (i = n.right),
        this.animate_css &&
    ...
    _initLayout: function () {
      ;(this._el.attribution = TL.Dom.create('div', 'tl-attribution', this._el.container)),
        ...
        (this._el.slider_background = TL.Dom.create(
          'div',
          'tl-timenav-slider-background',
          this._el.slider
        )),
        (this._el.marker_container_mask = TL.Dom.create(
          'div',
          'tl-timenav-container-mask',
          this._el.slider
        )),
        (this._el.marker_container = TL.Dom.create(
          'div',
          'tl-timenav-container',
          this._el.marker_container_mask
        )),
        (this._el.marker_item_container = TL.Dom.create(
          'div',
          'tl-timenav-item-container',
          this._el.marker_container
        )),
        (this._el.timeaxis = TL.Dom.create('div', 'tl-timeaxis', this._el.slider)),
        (this._el.timeaxis_background = TL.Dom.create(
          'div',
          'tl-timeaxis-background',
          this._el.container
        )),
        (this._el.attribution.innerHTML =
          "<a href='http://timeline.knightlab.com' target='_blank'><span class='tl-knightlab-logo'></span>Timeline JS</a>"),
    ...
    _initData: function () {
      this._createMarkers(this.config.events),
        this.config.eras && ((this.has_eras = !0), this._createEras(this.config.eras)),
        this._drawTimeline()
    }
  })),
  (TL.TimeMarker = TL.Class.extend({
    ...
    setHeight: function (t) {
      ...
      ;(this._el.content_container.style.height = t + 'px'),
        ...
        (this._el.content.className =
          t <= 30 ? 'tl-timemarker-content tl-timemarker-content-small' : 'tl-timemarker-content'),
        t <= 56
          ? TL.DomUtil.addClass(this._el.content_container, 'tl-timemarker-content-container-small')
          : TL.DomUtil.removeClass(
              this._el.content_container,
              'tl-timemarker-content-container-small'
            ),
        TL.Browser.webkit
          ? ((i = Math.floor(t / 14)) < 1 && (i = 1),
            (this._text.className = 'tl-headline'),
            (this._text.style.webkitLineClamp = i))
          : ((i = t / 12),
            (this._text.className = 1 < i ? 'tl-headline tl-headline-fadeout' : 'tl-headline'),
            (this._text.style.height = 12 * i + 'px'))
    },
    setWidth: function (t) {
      this.data.end_date &&
    ...
    _initLayout: function () {
      if (
        ...
        (this._el.timespan_content = TL.Dom.create(
          'div',
        ...
        this._el.media_container = TL.Dom.create(
          'div',
  ...
  (TL.TimeEra = TL.Class.extend({
    ...
    _initLayout: function () {
      ;(this._el.container = TL.Dom.create('div', 'tl-timeera')),
        this.data.unique_id && (this._el.container.id = this.data.unique_id + '-era'),
        this.data.end_date &&
          ((this.has_end_date = !0),
  ...
  (TL.TimeScale = TL.Class.extend({
    initialize: function (t, e) {
      var i = t.events
      ;(this._scale = t.scale),
        (e = TL.Util.mergeData({ display_width: 500, screen_multiplier: 3, max_rows: null }, e)),
    ...
    _computeRowInfo: function (t, e) {
      for (var i = [], n = 0, a = 0; a < t.length; a++) {
        ...
        if (void 0 === s.row)
          ...
          else if (0 < e) (s.row = i.length), i.push(s), e--
          else {
    ...
    _computePositionInfo: function (t, e, i) {
      ...
      for (var n = [], a = !1, s = 0; s < t.length; s++) {
        ...
        if ((this._positions.push(o), void 0 !== t[s].end_date)) {
      ...
      if (n.length) {
        ...
        for (var l = [], s = 0; s < n.length; s++)
          l[s] = { label: n[s], idx: s, positions: [], n_rows: 1, n_overlaps: 0 }
        for (var s = 0; s < this._positions.length; s++) {
          var o
          ;((o = this._positions[s]).group = n.indexOf(t[s].group || '')), (o.row = 0)
          for (var h, d = (h = l[o.group]).positions.length - 1; 0 <= d; d--)
  ...
  (TL.TimeAxis = TL.Class.extend({
    ...
    drawTicks: function (t, e) {
      ...
      ;(this._el.major.className = 'tl-timeaxis-major'),
        ...
        (this.major_ticks = this._createTickElements(
          i.major.ticks,
          this._el.major,
          this.dateformat_lookup[i.major.name]
        )),
        (this.minor_ticks = this._createTickElements(
          i.minor.ticks,
          this._el.minor,
          this.dateformat_lookup[i.minor.name],
          i.major.ticks
        )),
    ...
    _createTickElements: function (t, e, i, n) {
      ...
      var a = {},
        s
      if (((a[new Date(-1, 13, -30).getTime()] = !0), n))
        for (var o = 0; o < n.length; o++) a[n[o].getTime()] = !0
      for (var r = [], o = 0; o < t.length; o++) {
        var l = t[o]
        if (!(l.getTime() in a)) {
          var h = TL.Dom.create('div', 'tl-timeaxis-tick', e),
            d = TL.Dom.create('span', 'tl-timeaxis-tick-text tl-animate-opacity', h)
          ;(d.innerHTML = l.getDisplayDate(this.getLanguage(), i)),
            r.push({
              tick: h,
              tick_text: d,
    ...
    positionTicks: function (t, e, i) {
      ;(this._el.minor.className = i
        ? ((this._el.major.className = 'tl-timeaxis-major'), 'tl-timeaxis-minor')
    ...
    _positionTickArray: function (t, e, i) {
      if (t[1] && t[0]) {
        var n,
          a = 1
        e.getPosition(t[1].date.getMillisecond()) - e.getPosition(t[0].date.getMillisecond()) < i &&
          (a = Math.round(i / e.getPixelsPerTick()))
        for (var s = 1, o = 0; o < t.length; o++) {
          var r = t[o]
          ;(r.tick.style.left = e.getPosition(r.date.getMillisecond()) + 'px'),
            (r.tick_text.innerHTML = r.display_date),
            (r.tick.className =
              1 < a
                ? a <= s
                  ? ((s = 1), (r.tick_text.style.opacity = 1), 'tl-timeaxis-tick')
                  : (s++,
                    (r.tick_text.style.opacity = 0),
                    'tl-timeaxis-tick tl-timeaxis-tick-hidden')
                : ((r.tick_text.style.opacity = 1), 'tl-timeaxis-tick'))
        }
      }
    },
    _initLayout: function () {
  ...
  (TL.AxisHelper = TL.Class.extend({
    ...
    _getTicks: function (t, e) {
      for (
        var i = t._scaled_padding * e.factor, n = t._earliest - i, a = t._latest + i, s = [], o = n;
        o < a;
        o += e.factor
      )
        ...
        for (var i = 0; i < e.length - 1; i++) {
          ...
          d[t].push(
            new s({
              ...
              major: { name: a[0], factor: a[1] }
            })
          )
        }
      }
    t('human', TL.Date.SCALES),
      t('cosmological', TL.BigDate.SCALES),
      (s.HELPERS = d),
      (s.getBestHelper = function (t, e) {
        'number' != typeof e && (e = 100)
        var i = t.getScale(),
          n = d[i]
        if (!n) throw new TL.Error('axis_helper_scale_err', i)
        for (var a = null, s = 0; s < n.length; s++) {
          var o = n[s],
            r = o.getPixelsPerTick(t._pixels_per_milli),
            l,
            h
          if (e < r) return null == a ? o : Math.abs(e - r) < Math.abs(e - r) ? o : a
          a = o
        }
        return n[n.length - 1]
      })
  ...
  (TL.Timeline = TL.Class.extend({
    ...
    initialize: function (t, e, i) {
      ...
      if (
        ...
        var n = TL.Util.hexToRgb(i.default_bg_color)
        n
          ? (i.default_bg_color = n)
          : (delete i.default_bg_color, trace('Invalid default background color. Ignoring.'))
      }
      TL.Util.mergeData(this.options, i),
        ...
        this.options.is_embed && TL.DomUtil.addClass(this._el.container, 'tl-timeline-embed'),
        this.options.is_full_embed &&
          TL.DomUtil.addClass(this._el.container, 'tl-timeline-full-embed'),
        document.addEventListener('keydown', function (t) {
          var e = t.key,
            i = o._getSlideIndex(o.current_id),
            n = o.config.events.length - 1,
            a = o.config.title ? n + 1 : n,
            s = 0
          'ArrowLeft' == e ? 0 != i && o.goToPrev() : 'ArrowRight' == e && i != a && o.goToNext()
        }),
        this.options.relative_date
          ? 'undefined' != typeof moment
            ? o._loadLanguage(e)
            : TL.Load.js(this.options.script_path + '/library/moment.js', function () {
                o._loadLanguage(e), trace('LOAD MOMENTJS')
              })
          : o._loadLanguage(e)
    },
    _translateError: function (t) {
      return (
        t.hasOwnProperty('stack') && trace(t.stack),
    ...
    remove: function (t) {
      if (0 <= t && t < this.config.events.length) {
    ...
    getData: function (t) {
      if (this.config.title) {
        ...
        if (0 < t && t <= this.config.events.length) return this.config.events[t - 1]
      } else if (0 <= t && t < this.config.events.length) return this.config.events[t]
      return null
    },
    ...
    getSlide: function (t) {
      return 0 <= t && t < this._storyslider._slides.length ? this._storyslider._slides[t] : null
    },
    ...
    _updateDisplay: function (t, e, i) {
      ...
      i && (n = i),
        ...
        this.options.width <= this.options.skinny_size
          ...
          : (this.options.width <= this.options.medium_size && (a += ' tl-medium'),
            (this.options.layout = 'landscape')),
        TL.Browser.touch && (this.options.layout = TL.Browser.orientation()),
        TL.Browser.mobile
          ? ((a += ' tl-mobile'),
    ...
    _initData: function (t) {
      ...
      if ('string' == typeof t) {
        ...
        TL.TimelineConfig == t.constructor
          ? this.setConfig(t)
          : this.setConfig(new TL.TimelineConfig(t))
    },
    setConfig: function (t) {
      if (
        ((this.config = t), this.config.validate(), this._validateOptions(), this.config.isValid())
      )
        try {
          this._onDataLoaded()
        } catch (t) {
    ...
    _validateOptions: function () {
      for (
        ...
        ;(valid = !0),
          'number' == typeof n
            ? (valid = n == parseInt(n))
            : 'string' == typeof n && (valid = n.match(/^\s*(\-?\d+)?\s*$/)),
          valid || this.config.logError({ message_key: 'invalid_integer_option', detail: i })
      }
    },
    _initLayout: function () {
      var t = this
    ...
    _initGoogleAnalytics: function () {
      ...
      ;(t = window),
        (e = document),
        (i = 'script'),
        (n = '//www.google-analytics.com/analytics.js'),
        (a = 'ga'),
    ...
    showMessage: function (t) {
      this.message
        ...
        : (trace('No message display available.'), trace(t))
    },
    ...
    _onSlideChange: function (t) {
      this.current_id != t.unique_id &&
        ((this.current_id = t.unique_id), this._timenav.goToId(this.current_id), this._onChange(t))
    },
    ...
    _onLoaded: function () {
      this._loaded.storyslider &&
        ...
        this.options.hash_bookmark && '' != window.location.hash
          ...
          : (TL.Util.isTrue(this.options.start_at_end) ||
